...
class MainTest {
    ...
    void neuerNutzer(){
        ...
        Nutzer.startAnmeldungWarteraum(nutzer2.getName()); //Nutzer 2 will ein Spiel spielen und kommt ins Wartezimmer
        assertEquals(1, Main.warteraum.size());

        Nutzer.startAnmeldungWarteraum(nutzer1.getName());  //Nutzer 1 will auch spielen
